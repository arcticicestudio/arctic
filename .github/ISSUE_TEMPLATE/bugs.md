...
- **Ensure the bug is reproducible and has not already been fixed** — use the [latest version](https://github.com/arcticicestudio/arctic/releases/latest) and [`develop`](https://github.com/arcticicestudio/arctic/tree/develop) branch.
...
Provide a [MCVE - The Minimal, Complete, and Verifiable Example](https://github.com/arcticicestudio/arctic/blob/develop/CONTRIBUTING.md#mcve)
...
- Is the problem scoped to the website or any of the [provided packages](https://github.com/arcticicestudio/arctic/tree/develop/packages)?
