...
- **Check if the enhancement has already been implemented** — use the [latest version](https://github.com/arcticicestudio/arctic/releases/latest) and [`develop`](https://github.com/arcticicestudio/arctic/tree/develop) branch to ensure that the feature or improvement has not already been added.
