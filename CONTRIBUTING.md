...
Thanks for contributing to “arctic”!

This is a set of guidelines for contributing to “arctic”. Please take a moment to review this document in order to make the contribution process easy and effective for everyone involved.

Following these guidelines helps to communicate that you respect the time of the developers managing and developing this open source project. In return, they should reciprocate that respect in addressing your issue, assessing changes, and helping you finalize your pull requests.

As for everything else in the project, the contributions to “arctic” are governed by our [Code of Conduct][gh-contrib]. By participating, you are expected to uphold this code. Please report unacceptable behavior at support@arcticicestudio.com or directly to one of the core team members via [email][gh-tree-mailmap].

## Getting Started

“arctic” is an open source project and we love to receive contributions from the community! There are many ways to contribute, from [writing- and improving documentation and tutorials](#documentations), [reporting bugs](#bug-reports), [submitting enhancement suggestions](#enhancement-suggestions) which can be incorporated into this project by [submitting a pull request](#pull-requests).
...
“arctic” is a open source project using the [monolithic repository layout][trkbdev-monorepo] and contains [multiple packages][gh-tree-packages].
...
A bug is a _demonstrable problem_ that is caused by the code in the repository. This section guides you through submitting a bug report for “arctic”. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior and find related reports.
...
- **Did the problem start happening recently** e.g. after updating to a new version of “arctic” or was this always a problem?
  - If the problem started happening recently, **can you reproduce the problem in an older version of “arctic”?**
...
- **Explain why this enhancement would be useful** to most “arctic” users.
...
- **Include screenshots and animated GIFs if appropriate** to help visualize the reproduction steps and clearly demonstrate the problem.
- **Make sure to follow the [JavaScript](#javascript-style-guide) as well as the [Markdown](#markdown-style-guide) and [Git](#git-style-guide) style guides**.
...
“arctic” documentations consist of guides, which helps users to learn about the project which serves as a reference including the [packages][gh-tree-packages].
...
“arctic” uses the [gitflow][gitflow] branching model. The repository consists of two core branches with an infinite development lifecycle:
...
We're always looking for more opinions on discussions in issues and pull request reviews which is a good opportunity to influence the future direction of “arctic”.
...
All JavaScript/TypeScript sources and documentations adhere to the [Arctic Ice Studio JavaScript Style Guide][gh-styleguide-javascript].

<a href="https://github.com/arcticicestudio/styleguide-javascript" target="_blank"><img src="https://raw.githubusercontent.com/arcticicestudio/styleguide-javascript/develop/assets/images/badge.svg?sanitize=true" width="200"/></a>

### Markdown Code Style

All Markdown sources and documentations adhere to the [Arctic Ice Studio Markdown Style Guide][gh-styleguide-markdown].

<a href="https://github.com/arcticicestudio/styleguide-markdown" target="_blank"><img src="https://raw.githubusercontent.com/arcticicestudio/styleguide-markdown/develop/assets/images/badge.svg?sanitize=true" width="200"/></a>
...
“arctic” adheres to the [Arctic Ice Studio Git Style Guide][gh-styleguide-git].

<a href="https://github.com/arcticicestudio/styleguide-markdown" target="_blank"><img src="https://raw.githubusercontent.com/arcticicestudio/styleguide-git/develop/assets/images/badge.svg?sanitize=true" width="200"/></a>
...
[gh-branch-develop]: https://github.com/arcticicestudio/arctic/tree/develop
[gh-changelog]: https://github.com/arcticicestudio/arctic/blob/develop/CHANGELOG.md
[gh-contrib]: https://github.com/arcticicestudio/arctic/blob/develop/CODE_OF_CONDUCT.md
[gh-gist]: https://gist.github.com
[gh-issues-label-question]: https://github.com/arcticicestudio/arctic/labels/question
[gh-issues-template-bug]: https://github.com/arcticicestudio/arctic/blob/develop/.github/ISSUE_TEMPLATE/bugs.md
[gh-issues-template-enhancement]: https://github.com/arcticicestudio/arctic/blob/develop/.github/ISSUE_TEMPLATE/enhancement.md
[gh-issues-template-pr]: https://github.com/arcticicestudio/arctic/blob/develop/.github/PULL_REQUEST_TEMPLATE.md
[gh-issues-templates]: https://github.com/arcticicestudio/arctic/issues/new/choose
[gh-issues]: https://github.com/arcticicestudio/arctic/issues
[gh-pr]: https://github.com/arcticicestudio/arctic/pulls
[gh-releases-latest]: https://github.com/arcticicestudio/arctic/releases/latest
...
[gh-tree-mailmap]: https://github.com/arcticicestudio/arctic/blob/develop/.mailmap
[gh-tree-packages]: https://github.com/arcticicestudio/arctic/tree/develop/packages
...
[trkbdev-monorepo]: https://trunkbaseddevelopment.com/monorepos
